...
declare function decodeInt(encodedInt: string): number;
...
export { Encoder, type I_BroadcastTxResult, type I_CheckTx, type I_DeliverTx, type I_NetworkSettings, type I_TxInfo, Keystore, MasternodeAPI, type T_NetworkType, TransactionBuilder, Utils, Wallet, _default as default };
